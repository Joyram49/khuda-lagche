...
function AboutLinks() {
  return (
    <div className='flex flex-col lg:flex-row justify-center items-start lg:items-center gap-y-3 lg:gap-y-0 gap-x-10 text-[#9a9a9a] font-medium font-robotoSlab lg:divide-x-[1px] divide-[#9a9a9a] divide-dotted pt-10'>
