...
function TeamMemberCard({ data }) {
  return (
    <Card className='w-full shadow-lg rounded-[36px] overflow-hidden bg-topBackground justify-self-center border-[1px] border-border dark:border-borderF '>
      <CardContent className='p-0'>
        ...
        <div className=' flex flex-col items-center gap-y-4 px-4 py-10'>
          ...
          <p className='font-robotoSlab  text-center text-pretty text-pText text-sm'>
            {data.description}
          </p>
