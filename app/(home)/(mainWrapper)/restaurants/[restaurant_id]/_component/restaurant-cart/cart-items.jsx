  ...
  return (
    <div className='flex flex-col gap-y-2 '>
      ...
      <div className='flex flex-col gap-y-2'>
        {items?.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className='flex flex-row justify-between items-between border-b-[1px] border-border dark:border-borderF py-4 mr-2 gap-x-4 font-robotoSlab'
            >
      ...
      <div className='flex flex-col gap-y-2 mt-10 mr-2'>
        ...
        <div className='flex justify-between items-center border-b-[1px] border-border dark:border-borderF mb-1 text-[12px] font-robotoSlab'>
          <p>Sub total</p>
