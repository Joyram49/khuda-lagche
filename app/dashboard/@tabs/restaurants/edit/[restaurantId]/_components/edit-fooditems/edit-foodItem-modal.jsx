...
function EditFoodItemModal({ onClose, foodInfo, restaurantInfo, categories }) {
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      delivery_time: parseInt(foodInfo?.delivery_time, 10) || 30,
      preparation_time: parseInt(foodInfo?.preparation_time, 10) || 15,
      price: parseInt(foodInfo?.price, 10) || 0,
      quantity: parseInt(foodInfo?.quantity, 10) || 1,
