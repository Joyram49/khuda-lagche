function RelatedFoodBigLoader() {
  return (
    <div className='h-auto lg:max-h-[75vh] 2xl:max-h-[60vh] hidden xl:w-1/4 border-[1px] border-slate-900/10 drop-shadow-sm rounded-md px-2 py-4 xl:flex flex-col justify-start items-center gap-y-4 overflow-y-auto scrollbar-thin scrollbar-thumb-customYellow scrollbar-track-gray-200 overflow-x-hidden animate-pulse'>
      <div className='h-6 w-3/4 bg-gray-200 dark:bg-gray-500 rounded self-start'></div>
          ...
          .map((_, index) => (
            ...
            >
              <div className='p-2 w-full flex gap-x-3 justify-between'>
                {/* Image Placeholder */}
                <div className='w-20 h-20 bg-gray-200 dark:bg-gray-500 rounded'></div>
                {/* Text and Content */}
                <div className='w-full flex flex-col gap-y-2'>
                  <div className='h-5 w-3/4 bg-gray-200 dark:bg-gray-500 rounded'></div>
                  <div className='h-4 w-1/2 bg-gray-200 dark:bg-gray-500 rounded'></div>
                  <div className='flex justify-start items-center gap-x-1'>
                    <div className='h-4 w-12 bg-gray-200 dark:bg-gray-500 rounded'></div>
                    <div className='h-5 w-5 bg-gray-200 dark:bg-gray-500 rounded-full'></div>
                  </div>
                </div>
              </div>
            </div>
